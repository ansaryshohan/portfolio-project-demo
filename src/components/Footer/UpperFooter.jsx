...
function UpperFooter({ onClickScrollHandler }) {
  return (
    <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      {/* Brand Name column */}
      <div className="lg:w-1/3 pr-16">
        <div className="border-r border-footer-line-color pr-8">
          <a
            ...
            <li>
              ...
              >
                <input
                  ...
                  className="mt-5 bg-[#101211] border border-solid border-[#222623] text-white h-12 px-3 py-4 outline-none"
                  required
                />
                <button type="submit" className="absolute right-5 top-[50%]">
                  <a href="#">
