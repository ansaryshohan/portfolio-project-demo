...
function SingleWorkExperience({ work }) {
  ...
  return (
    <div className="flex flex-col justify-center align-center gap-8 md:flex-row md:justify-around md:items-center md:gap-5 work-experience-card w-11/12 mx-auto md:w-full">
      {/* years */}
      <div className="md:w-[20%] w-full mx-auto">
        <h3 className="text-heading-color text-lg xs:text-3xl text-center font-bold leading-9">
          {years}
        </h3>
      </div>
      ...
      <div className="md:w-[50%] xs:w-4/6 w-full mx-auto text-center">
        <h3 className="text-heading-color text-lg xs:text-2xl  font-bold leading-7">
          {position}
        </h3>
